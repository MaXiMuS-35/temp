...
int validation(double* arr1, double* arr_origin, int size) //with certain compiler settings, errors may occur for large n (>10^5)
{
    int flag = 0;
...
int main()
{
    ...
    flag = validation(array2, array0, amount);//with certain compiler settings, errors may occur for large n {
